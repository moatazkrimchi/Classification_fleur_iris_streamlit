...
st.write('''
# Application pour la prévison des fleurs d'Iris 
...
def user_input():
    spal_length = st.sidebar.slider('La longueur du Sepal',4.3,7.9,5.3)
    spal_width = st.sidebar.slider('La largeur du Sepal',2.0,4.4,3.3)
    ...
    data={
        'spal_length': spal_length,
        'spal_width' : spal_width,
